...
// Disable caching for dev/live updates so browser never uses stale app.js
app.use((req, res, next) => {
  if (req.path.endsWith('.js') || req.path.endsWith('.css') || req.path.endsWith('.html') || req.path.startsWith('/api')) {
